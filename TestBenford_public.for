        PROGRAM TestBenford
C  
C FOR INDIVIDUAL SCIENTIFIC USE: REPLICATION OF THE RESULTS IN THE PAPER
C "WHO IS AFRAID OF BENFORD-SAVVY DATA MANIPULATIONS?"
C
C      
...
C
C GOALS:
C * follow Barabesi et al. (JASA, 2021) and replicate some of the 
